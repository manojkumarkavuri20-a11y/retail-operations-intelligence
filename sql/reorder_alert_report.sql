-- Reorder alerting: days of supply, reorder status, and suggested restock quantity by SKU
-- Retail Operations Intelligence | Author: Manoj Kumar Kavuri | PostgreSQL
...
-- Expected output: sku_id, product_name, category, aisle_location, supplier, units_in_stock,
-- avg_daily_sales, days_of_supply, reorder_status, suggested_reorder_qty, estimated_reorder_cost
-- Note: this file's own inventory/daily_sales table naming differs from the stock_system naming
-- used elsewhere in this repo. See docs/data_dictionary.md for the full schema-consistency note.
